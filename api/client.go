...
func CreateClientForTenant(ctx context.Context, tenantName string, clientRequest types.ClientRequest, r *http.Request) (*types.ClientResponse, error) {
	...
	var clientResponse types.ClientResponse
